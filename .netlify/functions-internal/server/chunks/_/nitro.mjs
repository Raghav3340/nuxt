...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "23092f6e-f474-4295-9ab0-c2418211b7e5",
...
const _lazy_V2j_Z8 = () => import('../routes/api/aem-fragment.mjs');
const _lazy_EZqjEQ = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/aem-fragment', handler: _lazy_V2j_Z8, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_EZqjEQ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_EZqjEQ, lazy: true, middleware: false, method: undefined }
];
...
export { parseQuery as A, withTrailingSlash as B, withoutTrailingSlash as C, hash$1 as D, normalizeCookieHeader as a, normalizeLambdaOutgoingBody as b, normalizeLambdaOutgoingHeaders as c, defineEventHandler as d, useRuntimeConfig as e, getResponseStatusText as f, getRouteRulesForPath as g, getResponseStatus as h, defineRenderHandler as i, joinRelativeURL as j, getQuery as k, createError$1 as l, getRouteRules as m, normalizeLambdaIncomingHeaders as n, createHooks as o, getContext as p, createRouter$1 as q, defu as r, hasProtocol as s, toRouteMatcher as t, useNitroApp as u, joinURL as v, withQuery as w, sanitizeStatusCode as x, isScriptProtocol as y, executeAsync as z };

import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref, computed, toValue, reactive, defineComponent, withAsyncContext, mergeProps, useSSRContext } from 'vue';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: html } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/aem-fragment", "$2H4rskkNwp")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "aem-fragment" }, _attrs))}>${unref(html) ?? ""}</div>`);
    };
  }
});

const useAemFragment = (fragmentName) => {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const html = useAemFragment("himalayan-odyssey");
    return (_ctx, _push, _parent, _attrs) => {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "UpcomingRides",
  __ssrInlineRender: true,
  setup(__props) {
    const html = useAemFragment("upcoming-rides");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}>${unref(html) ?? ""}</div>`);
    };
  }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "main-container" }, _attrs))} data-v-e7a3321a>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e7a3321a"]]);

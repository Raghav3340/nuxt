import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, computed, unref, ref, h, Suspense, nextTick, mergeProps, provide, useSSRContext, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from 'vue';
import { o as createHooks, p as getContext, l as createError$1, t as toRouteMatcher, q as createRouter, r as defu, s as hasProtocol, v as joinURL, w as withQuery, x as sanitizeStatusCode, y as isScriptProtocol, z as executeAsync } from '../_/nitro.mjs';
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, asyncDataDefaults as d, createError as e, fetchDefaults as f, generateRouteKey$1 as g, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useRouter as u };
